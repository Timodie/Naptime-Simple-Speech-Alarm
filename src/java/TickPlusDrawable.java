 ...
 * A simple tick plus animation to indicate you are all set with intro
 */
...
public class TickPlusDrawable extends Drawable {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        mBounds.left = (float)(bounds.left + padding);
        mBounds.right = (float)(bounds.right - padding);
        mBounds.top = (float)(bounds.top + padding*2);
        mBounds.bottom = (float)(bounds.bottom - padding*2);
